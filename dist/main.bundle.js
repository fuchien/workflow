...
var FirstFormDatasService = (function () {
    ...
    FirstFormDatasService.getRespostas = function () {
        return this.respostas;
    };
    FirstFormDatasService.setRespostas = function (respostas) {
...
var FirstFormComponent = (function () {
    function FirstFormComponent(fb, router, snackbarService, firstFormService) {
        ...
        this.myForm = fb.group({
            ...
            'cpf': ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].pattern(this.numberPattern)]]
        });
    }
    FirstFormComponent.prototype.ngOnInit = function () {
        ...
        this.firstFormService.pegarRespostas()
            .subscribe(function (respostas) { return _this.respostas = respostas; });
        this.firstFormService.pegarModalidades()
            .subscribe(function (modalidades) { return _this.modalidades = modalidades; });
        this.myForm.get('canal').valueChanges.subscribe(function (form) {
            if (form != null) {
                ...
                var respostas = _this.respostas.filter(function (resposta) { return resposta.canal_id == form.ID; });
                __WEBPACK_IMPORTED_MODULE_4__first_form_datas_service__["a" /* FirstFormDatasService */].setRespostas(respostas);
                _this.value += 50;
                _this.myForm.get('fila').enable();
                _this.filaIsDisabled = false;
                return;
            }
            _this.value = 0;
            _this.myForm.get('fila').disable();
            _this.filaIsDisabled = true;
        });
        this.myForm.get('fila').valueChanges.subscribe(function (form) {
            if (form != null) {
                _this.filaId = form.ID;
                _this.value += 50;
                _this.myForm.get('cpf').enable();
                _this.cpfIsDisabled = false;
                return;
            }
            _this.value = 50;
            _this.myForm.get('cpf').disable();
            _this.cpfIsDisabled = true;
        });
        this.myForm.get('cpf').valueChanges.subscribe(function (form) {
            if (form.cpf != '') {
    ...
    FirstFormComponent.prototype.localizarUser = function (value, valid) {
        ...
        if (value.cpf.length <= 8) {
            dados = this.pessoas.find(function (pessoa) { return pessoa.pernumper == value.cpf; });
        }
        if (value.cpf.length == 11) {
            dados = this.pessoas.find(function (pessoa) { return pessoa.cpf == value.cpf; });
        }
...
var FirstFormService = (function () {
    ...
    FirstFormService.prototype.pegarFilas = function () {
        ...
        return this.http.get("https://www.mocky.io/v2/5a2a73392d0000121491b10b")
            .map(function (res) { return res.json(); });
    };
...
var RespostaComponent = (function () {
    function RespostaComponent(fb) {
        ...
        this.userForm = fb.group({
            'telefone': [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            'tipoOcorrencia': [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            'numero': [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].pattern(this.numberPattern)]],
            'ocorrencia': [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]]
        });
    }
    RespostaComponent.prototype.ngOnInit = function () {
        ...
        this.respostas = __WEBPACK_IMPORTED_MODULE_2__first_form_first_form_datas_service__["a" /* FirstFormDatasService */].getRespostas();
        this.respForm.get('parecerForm.resposta').valueChanges.subscribe(function (respostas) {
            if (respostas.ID == 2 || respostas.ID == 8 || respostas.ID == 14) {
                _this.modalidades = [];
                return;
            }
            _this.modalidades = _this.dadosPessoais.modalidades;
        });
    };
    RespostaComponent.prototype.setStep = function (index) {
        this.step = index;
    };
    RespostaComponent.prototype.addUser = function (form, valid) {
        if (!valid)
            return;
    ...
    RespostaComponent.prototype.removeUser = function (user) {
        this.usersCadastrados = this.usersCadastrados.filter(function (users) { return users != user; });
        this.dadosPessoais.telefones = this.dadosPessoais.telefones.filter(function (tel) { return tel != user.numero; });
    };
